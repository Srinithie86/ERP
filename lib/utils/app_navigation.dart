...
import 'package:manufacturing_erp/modules/formula/bom/bom_screen.dart'
    as mfg_bom;
import 'package:manufacturing_erp/modules/formula/formula_screen.dart'
    as mfg_formula;
import 'package:manufacturing_erp/modules/job_card/job_card_screen.dart'
    as mfg_job;
import 'package:manufacturing_erp/modules/material_request/material_request_screen.dart'
    as mfg_material;
import 'package:manufacturing_erp/modules/production/production_screen.dart'
    as mfg_production;
import 'package:manufacturing_erp/modules/production_order/production_order_screen.dart'
    as mfg_po;
import 'package:manufacturing_erp/modules/quality/pages/quality_list_screen.dart'
    as mfg_quality;

// HRM Admin Imports
import 'package:hrm_admin_app/Screens/Admin/PerformanceManagement/performance_management.dart'
    as hrm_admin_performance;
...
import 'package:hrm_admin_app/Screens/Admin/PermissionManagement/admin_permission_management.dart'
    as hrm_admin_permission;
import 'package:hrm_admin_app/Screens/Admin/ExpenseManagement/admin_expense_management.dart'
    as hrm_admin_expense;
import 'package:hrm_admin_app/Screens/Admin/PayrollManagement/admin_payroll_management.dart'
    as hrm_admin_payroll;
import 'package:hrm_admin_app/Screens/Admin/ComplaintManagement/admin_complaint_management.dart'
    as hrm_admin_complaint;
import 'package:hrm_admin_app/Screens/Admin/EmployeeManagement/admin_employee_details.dart'
    as hrm_admin_employee;
import 'package:hrm_admin_app/Screens/Admin/AttendanceManagement/admin_attendance_management.dart'
    as hrm_admin_attendance;
import 'package:hrm_admin_app/Screens/Admin/AttendanceManagement/office_attendance.dart'
    as hrm_admin_office_att;
import 'package:hrm_admin_app/Screens/Admin/AttendanceManagement/mobile_attendance.dart'
    as hrm_admin_mobile_att;
import 'package:hrm_admin_app/Screens/Admin/LeaveManagement/admin_leave_requests.dart'
    as hrm_admin_leave_req;
import 'package:hrm_admin_app/Screens/Admin/LeaveManagement/admin_leave_status.dart'
    as hrm_admin_leave_status;
import 'package:hrm_admin_app/Screens/Admin/PermissionManagement/admin_permission_status.dart'
    as hrm_admin_permission_status;
import 'package:hrm_admin_app/Screens/Admin/PermissionManagement/admin_permission_report.dart'
    as hrm_admin_perm_rep;
...
import 'package:hrm/views/marketing/marketing_selection.dart'
    as hrm_emp_marketing;
import 'package:hrm/views/marketing/marketing_screen.dart'
    as hrm_emp_marketing_view;
import 'package:hrm/views/home/ticket_raise.dart' as hrm_emp_ticket;
import 'package:hrm/views/attendance_history/attendance.dart'
    as hrm_emp_attendance;
import 'package:hrm/views/payroll/advance_salary_request.dart'
    as hrm_emp_advance;
...
class AppNavigation {
  static void handleNavigation(BuildContext context, String name,
    ...
    if (n == "DASHBOARD" || n.endsWith(" DASHBOARD")) {
      final bool handled =
          _openModuleDashboard(context, moduleContext: moduleContext);
      if (!handled) {
    ...
    if (n == "PURCHASE REQUEST" ||
      ...
      Navigator.push(
          context,
          MaterialPageRoute(
              builder: (context) => const SupplierQuotationsScreen()));
    } else if (n == "REQUEST FOR QUOTATION (RFQ)" || n == "RFQ") {
      Navigator.push(
          context, MaterialPageRoute(builder: (context) => const RFQScreen()));
      ...
      Navigator.push(context,
          MaterialPageRoute(builder: (context) => const QCInspectionsScreen()));
    } else if (n.contains("GRN") || n.contains("GOODS RECEIPT")) {
      Navigator.push(
          context, MaterialPageRoute(builder: (context) => const GRNScreen()));
    } else if (n == "REQUEST FOR APPROVAL" || n == "APPROVALS") {
      Navigator.push(context,
          MaterialPageRoute(builder: (context) => const RequestApprovals()));
...
// HRM Module
      ...
      Navigator.push(
          ...
          MaterialPageRoute(
              builder: (_) =>
                  const hrm_admin_office_att.OfficeAttendanceScreen()));
    } else if (n == "MOBILE ATTENDANCE") {
      Navigator.push(
          context,
          MaterialPageRoute(
              builder: (_) =>
                  const hrm_admin_mobile_att.MobileAttendanceScreen()));
    } else if (n == "LEAVE REQUEST" || n == "LEAVE REQUESTS") {
      Navigator.push(
          context,
          MaterialPageRoute(
              builder: (_) =>
                  const hrm_admin_leave_req.AdminLeaveRequestsScreen()));
    } else if (n == "PERMISSION REQUEST" || n == "PERMISSION REQUESTS") {
      Navigator.push(
          context,
          MaterialPageRoute(
              builder: (_) =>
                  const hrm_admin_perm_rep.AdminPermissionReportScreen()));
    } else if (n == "EXPENSE APPROVAL" ||
        n == "EXPENSE APPROVALS" ||
        n.contains("EXPENSE APPROVAL")) {
      Navigator.push(
          context,
          MaterialPageRoute(
              builder: (_) =>
                  const hrm_admin_exp_req.AdminExpenseRequestsScreen()));
    } else if (n.contains("LEAVE APPROVAL") ||
        n.contains("ADMIN LEAVE") ||
        n.contains("LEAVE APPROVEL")) {
      Navigator.push(
          context,
          MaterialPageRoute(
              builder: (_) =>
                  const hrm_admin_leave.AdminLeaveManagementScreen()));
    } else if (n.contains("LEAVE TYPES") ||
        n == "LEAVE" ||
        n == "LEAVE MANAGEMENT") {
      Navigator.push(
          context,
          MaterialPageRoute(
              builder: (_) => const hrm_leave.LeaveManagementScreen()));
    } else if (n == "PERMISSION STATUS" || n.contains("PERMISSION STATUS")) {
      Navigator.push(
          context,
          MaterialPageRoute(
              builder: (_) => const hrm_admin_permission_status
                  .AdminPermissionStatusScreen()));
      ...
      Navigator.push(
          ...
          MaterialPageRoute(
              builder: (_) => const hrm_leave.LeaveManagementScreen()));
    } else if (n == "EMPLOYEE DETAILS" ||
        n.contains("ADMIN EMPLOYEE") ||
        n.contains("STAFF DETAILS") ||
        (n.contains("ADMIN") && n.contains("EMPLOYEE"))) {
      Navigator.push(
          context,
          MaterialPageRoute(
              builder: (_) =>
                  const hrm_admin_employee.AdminEmployeeFeatureScreen()));
    } else if (n == "PERSONAL DETAILS UPDATE" ||
        n == "PERSONAL DETAILS" ||
        n == "EMPLOYEE" ||
        n == "EMPLOYEE DETAIL") {
      Navigator.push(
          context,
          MaterialPageRoute(
              builder: (_) => const hrm_employee.EmployeeDetailsScreen()));
    } else if (n == "ATTENDANCE STATUS" || n.contains("ATTENDANCE STATUS")) {
      Navigator.push(
          context,
          MaterialPageRoute(
              builder: (_) => const hrm_emp_attendance.AttendanceScreen()));
    } else if (n.contains("ATTENDANCE MANAGEMENT") ||
        n.contains("ATTENDANCE ADMIN") ||
        (n.contains("ATTENDANCE") && m.contains("ADMIN"))) {
      Navigator.push(
          context,
          MaterialPageRoute(
              builder: (_) => const hrm_admin_attendance
                  .AdminAttendanceManagementScreen()));
    } else if ((n.contains("LEAVE") && m.contains("ADMIN")) ||
        n.contains("ADMIN LEAVE")) {
      Navigator.push(
          context,
          MaterialPageRoute(
              builder: (_) =>
                  const hrm_admin_leave.AdminLeaveManagementScreen()));
    } else if (n == "EMPLOYEE COMPLAIN RAISE" ||
        n == "EMPLOYEE COMPLAINTS" ||
        n.contains("COMPLAIN RAISE")) {
      Navigator.push(
          context,
          MaterialPageRoute(
              builder: (_) => const hrm_emp_feedback.FeedbackSupportScreen()));
    } else if (n.contains("COMPLAINTS") || n.contains("COMPLAINT MANAGEMENT")) {
      Navigator.push(
          context,
          MaterialPageRoute(
              builder: (_) =>
                  const hrm_admin_complaint.AdminComplaintManagementScreen()));
      ...
      Navigator.push(
        ...
        n == "PAY ROLL" ||
        n == "PAYROLL AND ADVANCE" ||
        n == "PAYROLL & ADVANCE") {
      Navigator.push(
          context,
          MaterialPageRoute(
              builder: (_) => const hrm_emp_payroll.PayrollScreen()));
    } else if ((n.contains("PAYROLL") || n.contains("PAY ROLL")) &&
        m.contains("ADMIN")) {
      Navigator.push(
          context,
          MaterialPageRoute(
              builder: (_) =>
                  const hrm_admin_payroll.AdminPayrollManagementScreen()));
    } else if (n.contains("PAYROLL") ||
        n.contains("PAY ROLL") ||
        n.contains("SALARY")) {
      Navigator.push(
          context,
          MaterialPageRoute(
              builder: (_) => const hrm_emp_payroll.PayrollScreen()));
    } else if (n.contains("PERMISSION MANAGEMENT") ||
        (n.contains("PERMISSION") && m.contains("ADMIN"))) {
      Navigator.push(
          context,
          MaterialPageRoute(
              builder: (_) => const hrm_admin_permission
                  .AdminPermissionManagementScreen()));
    } else if (n == "EXPENSE" ||
        (n.contains("EXPENSE") && m.contains("ADMIN"))) {
      Navigator.push(
          context,
          MaterialPageRoute(
              builder: (_) =>
                  const hrm_admin_expense.AdminExpenseManagementScreen()));
    } else if (n == "LEAVE STATUS") {
      Navigator.push(
          context,
          MaterialPageRoute(
              builder: (_) =>
                  const hrm_admin_leave_status.AdminLeaveStatusScreen()));
    } else if (n.contains("EXPENSE MANAGEMENT") || n.contains("EXPENSE")) {
      Navigator.push(
          context,
          MaterialPageRoute(
              builder: (_) => const hrm_emp_expense.ExpenseManagementScreen()));
    } else if (n == "PERFORMANCE" ||
        (n.contains("PERFORMANCE") && m.contains("ADMIN"))) {
      Navigator.push(
          context,
          MaterialPageRoute(
              builder: (_) =>
                  const hrm_admin_performance.PerformanceManagementScreen()));
    } else if (n.contains("MY PERFORMANCE") || n.contains("PERFORMANCE")) {
      Navigator.push(
          context,
          MaterialPageRoute(
              builder: (_) => const hrm_emp_performance.PerformanceScreen()));
    } else if (n == "MARKETING ATTENDANCE") {
      Navigator.push(
          context,
          MaterialPageRoute(
              builder: (_) =>
                  const hrm_admin_marketing.MarketingAttendanceScreen()));
    } else if (n == "MARKETING") {
      Navigator.push(
          context,
          MaterialPageRoute(
              builder: (_) => const hrm_emp_marketing_view.MarketingScreen()));
    } else if (n.contains("MARKETING SELECTION")) {
      Navigator.push(
          context,
          MaterialPageRoute(
              builder: (_) =>
                  const hrm_emp_marketing.MarketingSelectionScreen()));
    } else if (n.contains("BREAK MONITOR") || n == "BREAK") {
      Navigator.push(
          context,
          MaterialPageRoute(
              builder: (_) => const hrm_admin_attendance
                  .AdminAttendanceManagementScreen()));
    } else if (n.contains("ADVANCE SALARY") || n.contains("ADVANCE REQUEST")) {
      Navigator.push(
          context,
          MaterialPageRoute(
              builder: (_) =>
      ...
      Navigator.push(
          context,
          MaterialPageRoute(
              builder: (_) => const hrm_emp_ticket.TicketRaise()));
    }
    ...
    // Manufacturing Module (when user is inside Manufacturing drawer)
      ...
      if (n.contains("BILL OF MATERIAL") ||
          n == "BOM" ||
          n.startsWith("BOM ") ||
          n.contains(" BOM")) {
        Navigator.push(context,
            MaterialPageRoute(builder: (_) => const mfg_bom.BomScreen()));
      } else if (n.contains("FORMULA") || n.contains("BOM FORMULA")) {
        Navigator.push(
            context,
            MaterialPageRoute(
                builder: (_) => const mfg_formula.FormulaScreen()));
      } else if (n.contains("PRODUCTION ORDER")) {
        Navigator.push(
            context,
            MaterialPageRoute(
                builder: (_) => const mfg_po.ProductionOrderScreen()));
      } else if (n.contains("JOB CARD")) {
        Navigator.push(context,
            MaterialPageRoute(builder: (_) => const mfg_job.JobCardScreen()));
        ...
        Navigator.push(
            context,
            MaterialPageRoute(
                builder: (_) => const mfg_material.MaterialRequestScreen()));
      } else if (n == "PRODUCTION" ||
          n.contains("PRODUCTIONS") ||
          n.contains("PRODUCTION PROCESS")) {
        Navigator.push(
            context,
            MaterialPageRoute(
                builder: (_) => const mfg_production.ProductionEntryScreen()));
      } else if (n.contains("QUALITY") || n.contains("QC")) {
        Navigator.push(
            context,
            MaterialPageRoute(
                builder: (_) => const mfg_quality.QualityListScreen()));
      } else {
        Navigator.push(context,
            MaterialPageRoute(builder: (_) => PlaceholderScreen(title: name)));
      }
    }
    // Generic
    else {
  ...
  static bool _openModuleDashboard(BuildContext context,
      {String? moduleContext}) {
    ...
    if (m.contains("HRM")) {
      Navigator.push(
        ...
        MaterialPageRoute(
            builder: (_) =>
                hrm.MainRoot(isEmbedded: true, scaffoldKey: moduleScaffoldKey)),
      );
      return true;
    }
    ...
    if (m.contains("ACCOUNTING")) {
      Navigator.push(context,
          MaterialPageRoute(builder: (_) => const accounting.MainShell()));
      return true;
    }
  ...
  static IconData getIcon(String name) {
    ...
    if (n.contains("MANUFACTURING"))
      return Icons.precision_manufacturing_outlined;
    if (n.contains("SERVICE")) return Icons.home_repair_service_outlined;

    // Action Icons
    if (n.contains("CREATE PR") || n == "PR" || n.contains("PURCHASE REQUEST"))
    ...
    if (n.contains("GRN") || n.contains("QC"))
    ...
    if (n.contains("HEALTH") && n.contains("SAFETY"))
      return Icons.health_and_safety_outlined;
    if (n.contains("EMPLOYEE DETAILS") || n.contains("STAFF DETAILS"))
      return Icons.badge_outlined;
    if (n.contains("ATTENDANCE MANAGEMENT") ||
        n.contains("ATTENDANCE ADMIN") ||
        (n.contains("ATTENDANCE") && n.contains("ADMIN")))
  ...
  static List<Color> getGradient(String name) {
    ...
    if (n.contains("APPROVAL"))
      return [const Color(0xfffbc02d), const Color(0xfffdd835)];
    if (n == "PR" || n.contains("PURCHASE"))
      return [const Color(0xff0288d1), const Color(0xff03a9f4)];
  ...
  static String getModuleImage(String name) {
    ...
    if (n.contains('ACCOUNTS') || n.contains('FINANCE'))
      return 'assets/images/financials.png';
