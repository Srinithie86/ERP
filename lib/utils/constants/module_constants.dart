...
import 'package:erp_smart/providers/menu_provider.dart' show MenuProvider;
...
List<ModuleItem> get allModules => [
      ModuleItem(
        ...
        screenBuilder: (context) =>
            MasterScreen(isEmbedded: true, scaffoldKey: moduleScaffoldKey),
      ),
      ModuleItem(
        title: 'HRM',
      ...
      ModuleItem(
        ...
        screenBuilder: (context) => purchase.Dashboard(
      ...
      ModuleItem(
        ...
        screenBuilder: (context) => ecommerce.MainShell(
            isEmbedded: true, scaffoldKey: moduleScaffoldKey),
      ),
      ModuleItem(
        title: 'Warehouse',
