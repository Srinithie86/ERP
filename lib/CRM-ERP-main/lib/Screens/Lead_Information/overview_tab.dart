...
class EnquiryOverviewDetailView extends StatelessWidget {
      ...
      child: Column(
        ...
        children: [
          ...
          GestureDetector(
            ...
            child: _buildIconTextRow(Icons.phone_iphone_outlined, phone, isClickable: true),
          ),
          if (phone2.isNotEmpty && phone2 != phone)
            GestureDetector(
              onTap: () => _confirmCall(context),
              child: _buildIconTextRow(Icons.phone_iphone_outlined, phone2, isClickable: true),
            ),
          Padding(
  ...
  Widget _buildIconTextRow(IconData icon, String text, {bool isClickable = false}) {
    return Padding(
      padding: const EdgeInsets.symmetric(horizontal: 16.0, vertical: 4),
      child: Row(
        children: [
          ...
          Text(
            text,
            style: TextStyle(
              color: isClickable ? const Color(0xFF1A56A1) : Colors.grey,
              fontSize: 14,
