...
class _FollowUpScreenState extends State<FollowUpScreen> {
  ...
  List<dynamic> _displayList = []; // Cached list for UI
  ...
  String get _assetIcon {
    switch (_selectedIndex) {
      case 0:
        return 'assets/icons/leads.png'; // Fixed singular to plural
      case 1:
        return 'assets/icons/enquiry.png'; // Fixed path
      case 2:
        return 'assets/icons/re.png'; // Using existing icon for Referral
      default:
