...
class _MeetingVisitScreenState extends State<MeetingVisitScreen> {
  ...
  List<dynamic> _displayMeetings = []; // Cached for UI
      ...
      body: _isLoading 
        ...
        : RefreshIndicator(
            ...
            child: ListView.builder(
              ...
              itemCount: _displayMeetings.length + 1, // +1 for the header section
                ...
                if (index == 0) {
                  return Column(
                    children: [
                      ...
                      if (_displayMeetings.isEmpty)
                        const Center(child: Padding(padding: EdgeInsets.all(20), child: Text("No meetings found"))),
                    ],
                  );
                }

                // History items
                final m = _displayMeetings[index - 1];
