  ...
  Future<void> _fetchLocationAndTime() async {
    try {
      ...
      if (permission == LocationPermission.deniedForever) {
        if (mounted) {
          setState(() => currentLocation = "Permission permanently denied");
  ...
  void _showLocationServiceDialog() {
    showDialog(
      ...
      builder: (context) => AlertDialog(
        ...
        content: const Text("Please enable location services to proceed with verification."),
        actions: [
          TextButton(
    ...
    showDialog(
      ...
      builder: (context) => AlertDialog(
        ...
        content: Text(isPermanent
            ...
            : "Location permission is required for attendance verification. Please grant access."),
        actions: [
          TextButton(
            onPressed: () => Navigator.pop(context),
            child: const Text("Cancel"),
          ...
          TextButton(
            ...
            child: Text(isPermanent ? "Open Settings" : "Grant"),
          ),
        ],
      ),
    );
