...
class FaceDetectorService {
  ...
  Future<FaceDetectionResult> processInputImage(InputImage inputImage) async {
    try {
      ...
      // Ensure the face is looking forward (Looser limits: Euler Y and Z)
      if (face.headEulerAngleY != null &&
          (face.headEulerAngleY! > 40 || face.headEulerAngleY! < -40)) {
        return FaceDetectionResult(
          isValid: false,
          error: "Please look more towards the camera.",
        );
      }
      ...
      if (face.headEulerAngleZ != null &&
        ...
        return FaceDetectionResult(
          isValid: false,
          error: "Please keep your head straighter.",
        );
      }
  ...
  bool isSamePersona(
    List<double> p1,
    List<double> p2, {
    double threshold = 0.35, // Relaxed threshold (approx 30% match requirement)
  }) {
