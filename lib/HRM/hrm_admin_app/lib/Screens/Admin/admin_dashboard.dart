...
import 'AttendanceManagement/admin_attendance_management.dart';
import 'AttendanceManagement/marketing_attendance.dart';
...
class AdminDashboard extends StatefulWidget {
  ...
  const AdminDashboard(
      {super.key, this.onBackToHrm, this.isEmbedded = false, this.scaffoldKey});
...
class _AdminDashboardState extends State<AdminDashboard> {
  ...
  Future<void> _fetchLeaveCount() async {
    ...
    try {
      ...
      final response =
          await LeaveApi.fetchLeaveRequests(reportingManager: reportingManager);
      if (mounted) {
        setState(() {
              ...
              children: [
                _buildSmallShortcut(
                  ...
                  onTap: () => Navigator.push(
                      context,
                      MaterialPageRoute(
                          builder: (_) => const AdminEmployeeFeatureScreen())),
                ),
                _buildSmallShortcut(
                  "Leave",
                  ...
                  onTap: () => Navigator.push(
                      context,
                      MaterialPageRoute(
                          builder: (_) => const AdminLeaveManagementScreen())),
                ),
                _buildSmallShortcut(
                  "Salary",
                ...
                _buildSmallShortcut(
                  ...
                  onTap: () => AppNavigation.handleNavigation(context, "MARKETING ATTENDANCE"),
                ),
                _buildSmallShortcut(
                  "Complaints",
                  Icons.gavel_rounded,
        ...
        children: [
          ...
          Container(
            ...
            child: Icon(Icons.chevron_right_rounded,
                color: const Color(0xFF475569), size: 20.sp),
          ),
        ],
      ),
    );
