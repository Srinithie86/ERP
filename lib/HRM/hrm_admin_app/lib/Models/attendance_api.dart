...
class AttendanceResponse {
  ...
  factory AttendanceResponse.fromJson(Map<String, dynamic> json) {
    ...
    final List<AttendanceData> parsedData = rawData
...
class AttendanceData {
  ...
  // Static caches to share names/codes between records (helps when API returns null for some types)
  ...
  static Future<AttendanceResponse> fetchMobileAttendance() async {
    try {
      ...
      if (response.statusCode == 200) {
        ...
        return AttendanceResponse.fromJson(decodedData);
      } else {
