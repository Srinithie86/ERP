...
class AttendanceApi {
  ...
  static Future<AttendanceResponse> fetchMobileAttendance({String? date}) async {
    try {
  ...
  static Future<AttendanceResponse> fetchInOfficeAttendance({String? date}) async {
    try {
      final params = await SharedPrefsUtil.getCommonParams();
      final Map<String, String> body = {
        'type': '2083',
  ...
  static Future<AttendanceResponse> fetchBreakAttendance({String? date}) async {
    try {
      final params = await SharedPrefsUtil.getCommonParams();
      final Map<String, String> body = {
        'type': '2083',
  ...
  static Future<AttendanceResponse> fetchMarketingAttendance({String? date}) async {
    try {
      final params = await SharedPrefsUtil.getCommonParams();
      final Map<String, String> body = {
        'type': '2083',
