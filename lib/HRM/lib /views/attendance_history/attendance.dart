...
class AttendanceScreenState extends State<AttendanceScreen> {
  ...
  String? overallTotalBreakTime;
  String? selectedDayTotalBreakTime;
    ...
    try {
      ...
      if (data["error"] == false || data["error"] == "false") {
        ...
        setState(() {
          ...
          // Per Day Total
          if (perDaySummaryList is List) {
            final dayData = perDaySummaryList.firstWhere(
