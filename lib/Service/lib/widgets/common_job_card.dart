                    ...
                    if (widget.audioUrl != null &&
                      ...
                      try {
                        ...
                        if (e.toString().contains('MissingPluginException')) {
                          launchUrl(Uri.parse(widget.audioUrl!), mode: LaunchMode.platformDefault);
                        } else {
                          ScaffoldMessenger.of(context).showSnackBar(
                            SnackBar(content: Text('Could not play audio internally: $e')),
                          );
                        }
                      }
                    }
                        ...
                        (index) {
                          ...
                          return Expanded(
                            child: Container(
                              ...
                              height: (index.isEven ? 10 : 22).h + ((index % 5) * 4).h,
                              decoration: BoxDecoration(
                                color: isActive ? const Color(0xFF322748) : const Color(0xFF65518D).withOpacity(0.3),
                                borderRadius: BorderRadius.circular(20.r),
                              ),
                            ),
                          );
