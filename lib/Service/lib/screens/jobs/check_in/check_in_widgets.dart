        ...
        child: Column(
          children: [
            Icon(
              ...
              color: hasImage ? const Color(0xFF3B9541) : const Color(0xFF7A879F),
              size: 22.sp,
            ),
            SizedBox(height: 8.h),
            Text(
              hasImage ? 'Image Selected' : (fileName?.isNotEmpty == true ? fileName! : 'Click to Image'),
              style: TextStyle(
                fontSize: 11.sp,
                color: hasImage ? const Color(0xFF3B9541) : const Color(0xFF667085),
            ...
            Text(
              ...
              style: TextStyle(
                fontSize: 8.5.sp,
                color: hasImage ? Colors.white.withValues(alpha: 0.8) : const Color(0xFF98A2B3),
              ),
            ),
          ],
        ),
