...
class AppData {
  ...
  final Map<String, dynamic> _profile = {
    ...
    'email': 'rajesh.kumar@support.com',
  ...
  final List<Map<String, dynamic>> _tickets = [
    {
      ...
      'user': 'Ramesh Kumar',
      'location': 'Block D - Finance Dept',
      'device': 'Samsung 1.5T AC',
      'priority': 'Medium',
      'status': 'Pending',
      'createdAt': DateTime(2026, 4, 6, 9, 30),
      'resolutionNote': null,
      'proofImagePath': null,
      'hasAudio': true,
      'audioUrl':
    ...
    },
    {
      ...
      'user': 'Suresh Nair',
      'location': 'Block C - HR Dept',
      'device': 'Dell Wired Keyboard',
      'priority': 'Low',
      'status': 'Pending',
    ...
    },
    {
      ...
      'user': 'Rahul Verma',
      'location': 'Block B - Admin Desk',
      'device': 'HP LaserJet M404',
      'priority': 'Low',
      'status': 'Accepted',
      'createdAt': DateTime(2026, 4, 6, 8, 40),
      'resolutionNote': null,
      'proofImagePath': null,
    },
    {
      'id': 'TCK-1039',
      'title': 'Wi-Fi dead zone complaint',
      'user': 'Facilities Team',
      'location': 'Block A - Meeting Room 4',
      'device': 'Cisco Access Point',
      'priority': 'High',
      'status': 'In Progress',
      'createdAt': DateTime(2026, 4, 6, 8, 0),
      'resolutionNote':
          'Signal survey started and channel overlap is being corrected.',
      'proofImagePath': null,
    },
    {
      'id': 'TCK-1035',
      'title': 'Blue screen after RAM upgrade',
      'user': 'Kiran Patel',
      'location': 'Block C - Floor 1',
      'device': 'Lenovo ThinkCentre',
      'priority': 'Medium',
      'status': 'Completed',
      'createdAt': DateTime(2026, 4, 5, 16, 10),
      'resolutionNote':
          'Reseated memory and updated BIOS. Device stable after stress test.',
      'proofImagePath': 'fix_proof_TCK-1035.jpg',
    },
  ];
