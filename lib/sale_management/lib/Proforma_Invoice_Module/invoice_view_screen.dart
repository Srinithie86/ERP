...
class ProformaInvoiceViewScreen extends StatefulWidget {
  ...
  const ProformaInvoiceViewScreen({
    super.key,
  ...
  @override
  State<ProformaInvoiceViewScreen> createState() =>
      _ProformaInvoiceViewScreenState();
}

class _ProformaInvoiceViewScreenState extends State<ProformaInvoiceViewScreen> {
  ...
  void _sendEmail() async {
    ...
    debugPrint("--- Email Debug Info (Proforma) ---");
      ...
      if (email.isEmpty || email == '0') {
        ...
        if (cusId != null) {
          ...
          try {
            ...
            debugPrint("Full Details Response: $res");
            if (res['error'] == false &&
                res['data'] != null &&
                (res['data'] as List).isNotEmpty) {
              // Find the specific customer in the list that matches the ID
              ...
              if (match != null) {
                ...
                debugPrint(
                    "Successfully matched Customer ID $cusId. Email: '$email'");
              } else {
                debugPrint(
                    "API returned data, but no record matching ID $cusId was found.");
              }
            }
          } catch (e) {
    ...
    final Uri emailLaunchUri = Uri(
      ...
      query: encodeQueryParameters(<String, String>{
        'subject': 'Proforma Invoice from Total ERP',
  ...
  Future<String?> _fetchNextNumber(String apiType) async {
    try {
      ...
      // Decide which API to use for number generation based on target type
                    ...
                    children: [
                      ...
                      Container(
                        decoration: BoxDecoration(
                          ...
                          border: const Border(
                              left: BorderSide(
                                  color: Color(0xFF005BBF), width: 5)),
                          boxShadow: [
                            BoxShadow(
                      ...
                      Container(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            _summaryRow(
                                'Total GST',
                                '₹ ${(s.igst + s.cgst + s.sgst).toStringAsFixed(2)}',
                                sp,
                                Colors.black87),
                                  ...
                                  children: [
                                    Text('TOTAL AMOUNT DUE',
                                        style: TextStyle(
                                            ...
                                            fontFamily: 'Poppins')),
                                    Text(
                                        '₹ ${s.finalPayable.toStringAsFixed(2)}',
                                        style: TextStyle(
        ...
        return Container(
          ...
          child: Column(
            ...
            children: [
              ...
              SizedBox(height: 20 * vp),
              _convertRow(
                  Icons.sync_alt, 'Proforma to Sales Invoice', sp, hp, vp,
                  onTap: () => _convertTo('Sales Invoice', '8005')),
              _convertRow(Icons.sync_alt, 'Proforma to Sales Order', sp, hp, vp,
                  onTap: () => _convertTo('Sales Order', '8001')),
              _convertRow(
                  Icons.sync_alt, 'Proforma to Delivery Challan', sp, hp, vp,
    ...
    return GestureDetector(
        ...
        child: Container(
          ...
          child: Row(
            children: [
              Icon(Icons.sync_alt,
                  color: const Color(0xFF00ACC1), size: 20 * sp),
              SizedBox(width: 12 * hp),
              Text(label,
                  style: TextStyle(
                      fontSize: 14 * sp,
        ...
        return Container(
          ...
          child: Column(
            ...
            children: [
              ...
              SizedBox(height: 30 * vp),
              SizedBox(height: 30 * vp),
              _sectionHeader('DANGER ZONE', const Color(0xFFE53935), sp),
              SizedBox(height: 20 * vp),
              Row(
                children: [
                  _OptionItem(
