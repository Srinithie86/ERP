...
class SalesOrderSelectedProductsScreen extends StatefulWidget {
  final List<SalesOrderProduct> selectedProducts;
  final double totalAmount;

  const SalesOrderSelectedProductsScreen({
    super.key,
  ...
  @override
  State<SalesOrderSelectedProductsScreen> createState() => _SalesOrderSelectedProductsScreenState();
}

class _SalesOrderSelectedProductsScreenState extends State<SalesOrderSelectedProductsScreen> {
                    ...
                    children: [
                      ...
                      GestureDetector(
                        ...
                        child: Icon(Icons.add_circle_outline,
                            color: const Color(0xFF005BBF), size: 22 * sp),
                      ),
                    ],
                  ),
