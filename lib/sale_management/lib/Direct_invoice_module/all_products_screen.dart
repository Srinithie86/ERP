...
class DirectInvoiceCatalogScreen extends StatefulWidget {
  ...
  const DirectInvoiceCatalogScreen({
    super.key,
    this.taxType = 'IGST',
  ...
  @override
  State<DirectInvoiceCatalogScreen> createState() => _DirectInvoiceCatalogScreenState();
}

class _DirectInvoiceCatalogScreenState extends State<DirectInvoiceCatalogScreen> {
  ...
  List<DirectInvoiceProduct> _products = [];
  ...
  List<DirectInvoiceProduct> get _filteredProducts {
    List<DirectInvoiceProduct> result = _products;
                          ...
                          ElevatedButton(
                            onPressed: () {
                              Navigator.push(
                                context,
                                MaterialPageRoute(
                                  builder: (_) => DirectInvoicePaymentScreen(
