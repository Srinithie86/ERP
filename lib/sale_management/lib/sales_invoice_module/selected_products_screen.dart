...
class SalesInvoiceSelectedProductsScreen extends StatefulWidget {
  final List<SalesInvoiceProduct> selectedProducts;
  final double totalAmount;
  final SalesInvoiceSummary? summary;

  const SalesInvoiceSelectedProductsScreen({
    super.key,
  ...
  @override
  State<SalesInvoiceSelectedProductsScreen> createState() => _SalesInvoiceSelectedProductsScreenState();
}

class _SalesInvoiceSelectedProductsScreenState extends State<SalesInvoiceSelectedProductsScreen> {
            ...
            child: Row(
              children: [
                ...
                ElevatedButton(
                  ...
                  child: Row(
                    children: [
                      Text('Done', style: TextStyle(fontWeight: FontWeight.bold, fontSize: 14 * sp, fontFamily: 'Poppins')),
                      SizedBox(width: 4 * hp),
