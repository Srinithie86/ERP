...
class EnquiryApi {
  ...
  static Future<Map<String, dynamic>> addEnquiry(Map<String, String> enquiryData) async {
    try {
      ...
      final Map<String, String> body = {
        'type': '2083', // Add Enquiry API Type
  ...
  static Future<List<dynamic>> fetchEnquiries() async {
    try {
      ...
      final Map<String, String> body = {
        ...
        'select': '*',
        'where': 'enquiry_type=2,assigned_to=${custId ?? ledId ?? ""}',
        'enquiry_type': '2', // Hardcoded for Enquiry
        'assign_to': custId ?? ledId ?? '',
        'assignTo': custId ?? ledId ?? '',
        'token': ?token,
