            ...
            child: Row(
              children: [
                Container(
                  ...
                  decoration: BoxDecoration(
                    color: (isAssigned ? Colors.green : const Color(0xFF26A69A)).withValues(alpha: 0.1),
                  ...
                  leading: Stack(
                    children: [
                      Container(
                        ...
                        decoration: BoxDecoration(
                          color: (m['active'] as bool) ? const Color(0xFF26A69A).withValues(alpha: 0.1) : Colors.grey.shade200,
