            ...
            Row(
              children: [
                Container(
                  ...
                  decoration: BoxDecoration(color: (meeting['color'] as Color).withValues(alpha: 0.1), borderRadius: BorderRadius.circular(14)),
              ...
              children: [
                ...
                TextButton(
                  ...
                  style: TextButton.styleFrom(
                    backgroundColor: (meeting['color'] as Color).withValues(alpha: 0.05),
